...
`auth/sso.py` (the sign-ins between the redirect and the callback, one use and ten minutes) and `auth/identity.py` (what production answers about the person a spent code names).
