...
from pinecall.api.deps import OrgsDep, PipelineKeyDep, SettingsDep, VaultDep, held
...
# Both doors ask for `pipeline`, the scope that turns the voice of an agent (api/agents/tuning.py,
