...
async def test_the_room_is_deleted_when_the_call_is_over() -> None:
    ...
    async with dispatching.a_dispatch(THE_CALL, THE_AGENT, A_BOX):
        pass
...
async def test_a_dispatch_for_nobody_in_particular_names_no_persona() -> None:
    ...
    async with dispatching.a_dispatch(THE_CALL, THE_AGENT, A_BOX, org="clinica"):
        pass
...
async def test_a_dispatch_in_nobodys_corner_leaves_the_holder_out() -> None:
    ...
    async with dispatching.a_dispatch(THE_CALL, THE_AGENT, A_BOX, org="clinica", env="production"):
        pass
