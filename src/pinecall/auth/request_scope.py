...
# is a person's, else the key itself — CI's, the box's — by the id its listing shows.
def author_of(record: KeyRecord) -> str:
    """Whom a row written on this key names as its author."""
    return record.subject or record.key_id
