...
def the_outbound(connection: HTTPConnection) -> Outbound | None:
...
def the_dispatches(connection: HTTPConnection) -> Dispatches | None:
...
def the_dial_policies(connection: HTTPConnection) -> DialPolicies:
...
def the_dials(connection: HTTPConnection) -> Dials:
...
async def kept_outbound_trunks(
    trunks: Annotated[OutboundTrunks | None, Depends(the_outbound_trunks)],
) -> OutboundTrunks:
...
DialPoliciesDep = Annotated[DialPolicies, Depends(the_dial_policies)]
