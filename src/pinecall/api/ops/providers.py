...
# exist, which of them this box has the plugin installed for, and whether a key is present — never a
# key, not even a prefix. api/org/provider_keys.py is still the only place a key goes in, and no
# door anywhere reads one back out.
#
